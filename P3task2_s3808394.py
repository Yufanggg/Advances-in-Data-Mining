...
def plot_xy_projection(data, labels):
    ...
    plt.figure()
    plt.scatter(data[:, 0], data[:, 1], marker="o", c = labels, cmap="viridis")
    plt.xlabel('X')
    plt.ylabel('Y')
    plt.show()
...
def plot_xz_projection(data, labels):
    ...
    # TO DO: Implement the function to plot the XY projection of the dataset
    plt.figure()
    plt.scatter(data[:, 0], data[:, 2], marker="o", c = labels, cmap="viridis")
    plt.xlabel('X')
    plt.ylabel('Z')
    plt.show()
...
def plot_yz_projection(data, labels):
    ...
    # TO DO: Implement the function to plot the XY projection of the dataset
    plt.figure()
    plt.scatter(data[:, 1], data[:, 2], marker="o", c = labels, cmap="viridis")
    plt.xlabel('Y')
    plt.ylabel('Z')
    plt.show()
...
def plot_pca_results(data_pca, labels):
    ...
    plt.figure()
    plt.scatter(data_pca[:, 0], data_pca[:, 1], marker="o", c = labels, cmap="viridis")
