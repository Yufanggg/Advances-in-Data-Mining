...
class FlajoletMartin:
    ...
    def add(self, item):
        ...
        for i in range(len(self.max_trailing_zeros)):
            ...
            Count_trailing_zero = self.count_trailing_zeros(hash_value)
            self.max_trailing_zeros[i] = Count_trailing_zero if self.max_trailing_zeros[i] < Count_trailing_zero else self.max_trailing_zeros[i]
