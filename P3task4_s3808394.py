...
def apply_tsne(X, n_components, perplexity, max_iter, init, random_state=2024):
    ...
    pipeline = make_pipeline(
        StandardScaler(),
        TSNE(n_components=n_components, init=init, perplexity=perplexity, n_iter= max_iter, random_state=random_state)
    )
...
if __name__ == "__main__":
    ...
    X_tsne_2d = apply_tsne(X, n_components=2, perplexity=30, max_iter=1000, init="pca", random_state=2024)
